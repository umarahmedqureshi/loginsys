...
<html lang="en">
  ...
  <body class="bg-secondary text-light">
    ...
    <!-- <div class="alert alert-success" role="alert"> -->
      <h4 class="text-primary">Hello - <?php echo $_SESSION['fname']?>!</h4>
      
      <p>Hey how are you doing? Welcome to my PHP website. You are logged in as <?php echo  $_SESSION['fname']?>. </p>
      <hr>
